<?php
    ...
    class InsertMultiple2
    {
        ...
        function __construct($type="MySQL_RDS")
        {
            $this->type = $type;
            ...
            {
                case 'MySQL_RDS':
                    $db = mysql_connect('cpamysql.c6lywwcjkgvq.us-east-1.rds.amazonaws.com','cpamaster','CPALores072') or die("Error al crear la conexión con MySQL RDS");
                    mysql_query("set names 'utf8'");
                    break;
                case 'Aurora':
                    $db = mysql_connect('cpamysqlaurora-cluster.cluster-c6lywwcjkgvq.us-east-1.rds.amazonaws.com','cpamaster','CPALores072') or die("Error al crear la conexión con AUrora");
                    mysql_query("set names 'utf8'");
                    break;
                case 'MariaDB':
                    /*$db = mysql_connect('cpamysqlaurora-cluster.cluster-c6lywwcjkgvq.us-east-1.rds.amazonaws.com','cpamaster','CPALores072') or die("Error al crear la conexión con AUrora");
                    mysql_query("set names 'utf8'");*/
                    echo 'Aún no hay una conexión definida para MariaDB';
                    break;
                default:
                    'No hay definición para la conexión especificada';
                break;
            }
        }
