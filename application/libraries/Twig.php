...
class Twig {
	...
	*/
	function __construct($debug = false) {
		...
		//HMVC patch
		//hack para evitar duplicar librerias dentro de los modulos
		$template_module_dir = (empty($this->CI->router->fetch_module()))? $this->CI->config->item('template_dir'): APPPATH.'modules/'.$this->CI->router->fetch_module().'/views/';
		$template_global_dir= $this->CI->config->item('template_dir');
		$this->_template_dir = array($template_module_dir, $template_global_dir);
		//end HMVC patch 
